...
-- ============================================================
-- AI ANALYSES (pre-seeded for resolved/closed complaints)
-- ============================================================
INSERT INTO public.ai_analyses (complaint_id, sentiment, sentiment_score, urgency, classification, summary, suggested_response, financial_loss_estimate)
VALUES
  ('11111111-0000-0000-0000-000000000004', 'Negative', 0.91, 'Critical', 'Billing - Duplicate Transaction',
   'Customer reports a duplicate charge of ₹12,450 on 15th April with specific transaction IDs provided. This is a clear system error requiring immediate financial remediation.',
   'Dear [Customer Name], thank you for bringing this to our attention. We have identified the duplicate transaction and are processing a refund of ₹12,450. Funds will be credited within 2 business days. We sincerely apologise for this error.',
   12450.00),

  ('11111111-0000-0000-0000-000000000011', 'Negative', 0.87, 'Medium', 'Service - Branch Conduct',
   'Customer experienced unprofessional treatment at Koramangala branch including a 3-hour wait and refusal of manager interaction. This represents a serious service quality failure.',
   'Dear [Customer Name], we are deeply sorry for the unacceptable service experience at our Koramangala branch. This falls far below our standards. We have taken immediate corrective action and would like to make this right.',
   0.00),

  ('11111111-0000-0000-0000-000000000012', 'Negative', 0.78, 'Medium', 'Billing - Late Fee Dispute',
   'Customer was charged a late fee during a documented portal outage and has screenshot evidence. The financial impact is ₹1,299 and the charge appears clearly erroneous.',
   'Dear [Customer Name], we have reviewed your case and confirmed the portal downtime on the payment due date. We are reversing the late fee of ₹1,299 immediately. This will reflect within 24 hours.',
   1299.00),

  ('11111111-0000-0000-0000-000000000013', 'Neutral', 0.65, 'Low', 'Service - Account Activation',
   'New customer facing a delay in savings account activation post-KYC completion. Standard backend processing queue issue with no financial impact.',
   'Dear [Customer Name], we apologise for the delay in activating your account. We have prioritised your request and your account is now active. Your welcome kit will arrive within 3-5 business days.',
   0.00),

  ('11111111-0000-0000-0000-000000000017', 'Neutral', 0.58, 'Medium', 'Technical - OTP Issue',
   'Customer changed their mobile number but the OTP was still routing to the old number due to a backend sync delay. Standard technical resolution needed.',
   'Dear [Customer Name], we have completed a forced synchronisation of your mobile number across our systems. You should now receive OTPs on your new number. Please try logging in again.',
   0.00),

  ('11111111-0000-0000-0000-000000000022', 'Negative', 0.82, 'Medium', 'Billing - Incorrect Charge',
   'Incorrect minimum balance penalty applied to a salary account which is exempt from such charges. Clear system misclassification of account type.',
   'Dear [Customer Name], we have verified that your Salary Account is exempt from minimum balance requirements. We are reversing the charge of ₹500 immediately. We apologise for this error.',
   500.00),

  ('11111111-0000-0000-0000-000000000025', 'Negative', 0.70, 'Low', 'Service - IVR Wait Time',
   'Systemic issue with customer care IVR causing excessive hold times and disconnections. Customer has experienced this multiple times indicating a recurring infrastructure problem.',
   'Dear [Customer Name], we sincerely apologise for the repeated poor experience with our customer care line. We have added you to our priority callback list and will ensure this does not recur.',
   0.00),

  ('11111111-0000-0000-0000-000000000026', 'Neutral', 0.55, 'Low', 'KYC - Video KYC Failure',
   'Video KYC session failed due to server-side connectivity issues. Customer rescheduled and completed successfully. No financial impact, minor inconvenience.',
   'Dear [Customer Name], we are glad your Video KYC was completed successfully. We apologise for the technical issues in the earlier sessions. Your account is now fully active.',
   0.00),

  ('11111111-0000-0000-0000-000000000043', 'Neutral', 0.50, 'Low', 'KYC - Document Policy',
   'Customer''s document was rejected due to a misunderstanding of the accepted document age policy. Issue resolved with policy clarification.',
   'Dear [Customer Name], we apologise for the confusion regarding our document acceptance policy. Your address proof has been accepted and your KYC is now complete.',
   0.00),

  ('11111111-0000-0000-0000-000000000048', 'Neutral', 0.60, 'Medium', 'Billing - TDS Certificate',
   'Customer needs TDS Form 16A for tax filing. Certificate was not available for download due to a portal generation delay. Time-sensitive given ITR deadline.',
   'Dear [Customer Name], your TDS certificates for FY2025-26 are now available for download in your AuraBank portal under Documents → Tax Certificates. We apologise for the delay.',
   0.00),

  ('11111111-0000-0000-0000-000000000049', 'Negative', 0.74, 'Low', 'Service - Branch Queue',
   'Customer experienced a 2.5-hour wait at Indiranagar branch due to inadequate staffing. Recurring operational inefficiency at this branch.',
   'Dear [Customer Name], we apologise for the long wait at our Indiranagar branch. We have flagged this to the branch manager and are reviewing staffing levels. Your time is valuable to us.',
   0.00)
